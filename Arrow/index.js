...
//  const greeting1= ()=> alert ("My name is Ariz ");
...
//   arr.forEach((data,ind)=> console.log(data))
// //   Ak tareka ye bhe hi
...
// const number=["13",'22','23','44','56','76','987'];
// const filtered=[];
// number.forEach((num,ind)=>{
//     if(num%2===0){
//         filtered.push(num)
//         }
//         })
...
const products = [
    {
      ...
      image: "https://images.unsplash.com/photo-1551022372-0bdac482b9d6?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8Ym95c3xlbnwwfHwwfHx8MA%3D%3D",
      rating: {
        rate: 3.9,
        count: 120,
      },
    },
    {
      ...
      category: "men's clothing",
      image:
        "https://images.unsplash.com/photo-1620228922597-cca58f177310?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjB8fGJveXN8ZW58MHx8MHx8fDA%3D",
      rating: {
        rate: 4.1,
        count: 259,
      },
